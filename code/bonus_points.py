...
class Bonus_points(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.groups = self.game.all_sprites, self.game.point_boost
        ...
        image_to_load = pygame.image.load('assets\images\points.jpg')
